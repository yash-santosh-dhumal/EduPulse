...
def login(payload: LoginRequest, session: Session = Depends(get_database_session)) -> TokenPair:
...
def refresh(payload: RefreshRequest, session: Session = Depends(get_database_session)) -> TokenPair:
